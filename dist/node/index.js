...
var createEventEmitter = require('@kirick/event-emitter');
var WebSocket = require('ws');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var createEventEmitter__default = /*#__PURE__*/_interopDefaultLegacy(createEventEmitter);
...
const BROKEN_STATES = new Set([
    WebSocket__default["default"].CLOSING,
    WebSocket__default["default"].CLOSED,
]);
...
class ExtWSClient {
    constructor (url, options = {}) {
        ...
        this._emitter = createEventEmitter__default["default"]();
    ...
    connect () {
        ...
        const ws = this._ws = new WebSocket__default["default"](this.url);
        ws._extws = {
            socket_id: null,
            idle_timeout: 60_000,
            ts_last_message: 0,
